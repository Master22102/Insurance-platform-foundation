/*
  Pass 6: Canonical incident status transition RPC
  - Auth-bound actor enforcement
  - Ownership checks on incident via trip owner
  - Canonical transition matrix enforcement
  - Evidence-gated transition into CLAIM_ROUTING_READY
  - Emit-or-rollback for canonical status event
*/
